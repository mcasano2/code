...
/* Page Table Entry for a 4KB page */
typedef struct __attribute__((packed)){
	...
	uint32_t accessed		: 1;
	uint32_t dirty			: 1;
	uint32_t ptattribute	: 1;
	uint32_t globalpage		: 1;
	uint32_t available		: 3;
	uint32_t pb_address		: 20;
}pt4Ke_desc_t;

/* Page Directory Entry for a 4KB page */
typedef struct __attribute__((packed)){
	uint32_t present 		: 1;
	uint32_t readwrite		: 1;
	uint32_t usersuper		: 1;
...
/* Page Directory entry for a 4MB page */
typedef struct __attribute__((packed)){
	uint32_t present 		: 1;
	uint32_t readwrite		: 1;
	uint32_t usersuper		: 1;
...
extern uint32_t *page_directory_array;
